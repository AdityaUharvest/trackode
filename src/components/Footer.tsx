...
export default function Footer() {
    return (
        <div>
            <footer className="bg-neutral-900 white:bg-white border-t-2  border-neutral-600 white:bg-white-900 ">
                <div className="container  px-6 py-6 mx-auto mt-3 white:bg-white-900">
                    <div className="flex flex-col  items-center text-center ">
                        <a href="#">
                            <img className=" w-auto h-7 fill-neutral-950 bg-neu"  src="footer-img.png" alt=""/>
                        </a>
                    ...
                    <hr className="my-6 border-neutral-500 border-t-2 md:my-10 dark:border-gray-700" />
