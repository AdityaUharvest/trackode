          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="px-8 sm:items-center sm:justify-center sm:px-0 sm:space-x-5 sm:flex mt-9 p-8">
              ...
              <Link
                href="/admin-dashboard"
                title=""
                className={`inline-flex items-center justify-center w-full px-6 py-3 mt-4 text-lg font-bold transition-all border-2 sm:w-auto sm:mt-0 rounded-xl font-pj focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  theme === "dark"
