...
export default function Home() {
  ...
  }, [session?.user]); // Add session?.user as a dependency
      ...
      <section className={`pt-12 ${theme === "dark" ? "bg-gray-900 text-white" : "bg-white text-black"} sm:pt-16`}>
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <div className="mt-5 text-4xl font-bold leading-tight sm:leading-tight sm:text-5xl lg:text-6xl lg:leading-tight ">
              <span>
                <SplitText
                  text="Track"
