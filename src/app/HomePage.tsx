  ...
  >
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className={`overflow-x-hidden  ${theme === "dark" ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
        ...
        <section
  className={`relative justify-center animate-slide-up flex flex-col ${theme === "dark" ? "bg-gray-900" : "bg-gradient-to-br from-cyan-50 via-white to-blue-100"} overflow-hidden min-h-[auto] sm:min-h-screen transition-all duration-500`} // Smoother gradient and transition
>
  ...
  <div className="absolute inset-0 pointer-events-none overflow-hidden">
    {theme === "dark" ? (
      <>
        <div
          className="absolute top-0 left-0 w-40 h-40 sm:w-72 sm:h-72 lg:w-112 lg:h-112 bg-gradient-to-r from-blue-800 to-cyan-900 rounded-full opacity-15 filter blur-2xl sm:blur-4xl animate-pulse-slow transform hover:scale-110 transition-transform duration-700" // Added scale on hover
        ></div>
        <div
  ...
  <div className="w-full pt-6 px-4 sm:px-8 z-20 relative">
    <div className="max-w-lg mx-auto"> {/* Slightly larger container */}
      <QuizJoinComponent />
    ...
    <div className="flex lg:mt-6 mt-6 flex-col items-center justify-start w-full sm:justify-center">
      ...
      <div className="text-center mb-6 sm:mb-10">
        <h1
          ...
          style={{ fontFamily: "'Exo 2', sans-serif",  }} // Bolder futuristic font
        >
          <span
      ...
      >
        <Link
          ...
          className="px-4 py-3 sm:py-4 text-base sm:text-base font-semibold text-white bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl hover:from-cyan-600 hover:to-blue-700 focus:outline-none focus:ring-4 focus:ring-cyan-400 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-xl hover:shadow-2xl relative overflow-hidden group"
        >
  ...
  `}</style>
        ...
        <section id="technology" className={` rounded-lg ${theme === "dark" ? "bg-gray-900" : "bg-gray-50"}`} aria-labelledby="tech-stack-heading">
           <TechStackQuizSystem />
